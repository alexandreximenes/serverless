...
public class VendaLambda {
    ...
    public APIGatewayProxyResponseEvent get(APIGatewayProxyRequestEvent request) {

        return new APIGatewayProxyResponseEvent().withStatusCode(200).withBody("Venda recebido");
    }
